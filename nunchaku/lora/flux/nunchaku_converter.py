...
def pack_lowrank_weight(weight, down):
...
def unpack_lowrank_weight(weight, down):
...
def reorder_adanorm_lora_up(lora_up, splits):
    c, r = lora_up.shape
    assert c % splits == 0
...
def fuse_vectors(vectors, base_sd, strength=1):
