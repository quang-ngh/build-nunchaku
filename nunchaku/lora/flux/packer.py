...
class NunchakuWeightPacker(MmaWeightPackerBase):
    ...
    def pack_scale(self, scale, group_size):
    ...
    def pack_micro_scale(self, scale, group_size):
        assert scale.dtype in (torch.float16, torch.bfloat16), "currently nunchaku only supports fp16 and bf16."
    ...
    def pack_lowrank_weight(self, weight, down):
    ...
    def unpack_lowrank_weight(self, weight, down):
    ...
    def check_if_micro_scale(self, group_size):
        return self.insn_k == group_size * 4

    def pad_weight(self, weight):
    ...
    def pad_scale(self, scale, group_size, fill_value=0):
    ...
    def pad_lowrank_weight(self, weight, down):
        assert weight.ndim == 2, "weight tensor should be 2D."
